!(function () {
        ...
        () => {
          ;((Dt = parseFloat(localStorage.getItem(Et)) || 0),
            ...
            (function () {
              ...
              ;((Gn.position.x = -0.5), (Gn.position.y = 0.5), (Gn.scale.x = bn), (Gn.scale.y = zn), Xn.add(Gn))
            })(),
            je.fps &&
              (function () {
  ...
  function Ut() {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      if (t.metaData.isSphere && t.id != Tt.id && t.id != bt.id) {
        ...
        let a = Qt(n),
          o = new Ye.Vector4(t.shape.x + 0.5 * t.shape.w, t.shape.y + 0.5 * t.shape.h, a, 0),
  ...
  function na() {
    ...
    let n = screen.availWidth,
      ...
      s = Math.ceil(r / a) * a,
      l = Math.ceil(i / o) * o
    ;(Kt() && ((s = r), (l = i), console.log('preview width', s, 'height', l, 'pixR', Tn, 'scale', it)), (s *= it), (l *= it), (bn == s && zn == l) || ((bn = s), (zn = l), console.log('perform resize: ', bn, zn, e), (En.left = En.top = 0), (En.right = bn), (En.bottom = zn), En.updateProjectionMatrix(), Cn.setSize(bn, zn, !1), (Cn.domElement.style.width = bn / it + 'px'), (Cn.domElement.style.height = zn / it + 'px'), (Mn.left = Mn.bottom = 0), (Mn.right = bn), (Mn.top = zn), Mn.updateProjectionMatrix(), Bn.setSize(bn * Tn, zn * Tn), (Ln.scale.x = bn), (Ln.scale.y = zn), (Ln.position.x = 0.5 * bn), (Ln.position.y = 0.5 * zn), (Gn.scale.x = bn), (Gn.scale.y = zn)))
  }
