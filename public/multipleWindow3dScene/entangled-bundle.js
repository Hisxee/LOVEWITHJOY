!(function () {
  ...
  function ue() {
    ...
    return (
      ...
      (e.pm = (function () {
        let e = {}
        switch (((e.type = ce.random_choice([0, 1, 1])), (e.sin = 0), (e.speed = 1), (e.noiseScale = 0.1), (e.nIndexMultiplier1 = 1e-7), (e.nIndexMultiplier2 = 0.001), (e.nRevolutions1 = 4), (e.nRevolutions2 = 8), (e.curlSize0 = 0.5), (e.curlSize1 = 1), (e.curlStrength0 = 1), (e.curlStrength1 = 1), (e.blur = 0), (e.blurRatio = 0.5), e.type)) {
          case 0: {
            e.sin = 0
            let n = ce.random_num(0, 1)
            ;((e.speed = a(n, 0, 1, 1, 7)), (e.noiseScale = 0.1), (e.nIndexMultiplier1 = 1e-7), (e.nIndexMultiplier2 = a(n, 0, 1, 38e-5, 0.0015)), (e.nRevolutions1 = 4), (e.nRevolutions2 = ce.random_int(6, 8)), (e.curlSize0 = 0.16), (e.curlStrength0 = 1.47), (e.curlSize1 = ce.random_num(0.3, 0.5)), (e.curlStrength1 = 1.47), (e.blur = ce.random_bool(0.5) ? ce.random_num(0, 0.23) : 0), (e.blurRatio = 0.15), ce.random_bool(0.5) && ((e.curlStrength1 *= 1.5), e.speed < 3 && (e.speed *= 2), (e.nRevolutions2 /= 2)))
            break
          }
          case 1: {
            e.sin = 1
            let n = ce.random_num(0, 1)
            ;((e.speed = a(n, 0, 1, 1, 1.5)), (e.noiseScale = 0.1), (e.nIndexMultiplier1 = 1e-7), (e.nIndexMultiplier2 = a(n, 0, 1, 38e-5, 0.0015)), (e.nRevolutions1 = 4), (e.nRevolutions2 = ce.random_int(3, 5)), (e.curlSize0 = 0.16), (e.curlStrength0 = 1.47), (e.curlSize1 = ce.random_num(1, 1.5)), (e.curlStrength1 = 0.6), (e.blur = ce.random_bool(0.5) ? ce.random_num(0, 0.23) : 0), (e.blurRatio = 0.15))
            break
          }
        }
        return e
  ...
  ;((me.schemeIndex = (function (e) {
    ...
    (me.rd = (function () {
      let e = {}
      switch (((e.type = ce.random_choice([0, 1, 1, 3, 2, 2, 2])), (e.scale = ce.random_int(1, 10)), (e.mapHalfSphere = ce.random_bool(0.5)), (e.mapRepeat = ce.random_bool(0.5)), (e.startFormationDrawCenter = ce.random_bool(0.5)), (e.feedRate = 0.029), (e.killRate = 0.05876), e.mapHalfSphere || (e.mapRepeat = !0), e.type)) {
        case 0:
          ;((e.mapHalfSphere = ce.random_bool(0.9)), (e.mapRepeat = !0), (e.progressionRat = 0), (e.startFormationNum = ce.random_int(3, 10)), (e.startFormationRad = ce.random_num(0.2, 0.4)), (e.startCircleRad = ce.random_num(0.1, 0.1)), (e.bumpMapSize = 0))
          break
        case 1:
          ;((e.progressionRat = 0.2), (e.scale = ce.random_num(1, 2)), (e.mapHalfSphere = ce.random_bool(0.9)), (e.mapRepeat = !0), (e.startFormationNum = ce.random_int(3, 10)), (e.startFormationRad = ce.random_num(0.3, 0.5)), (e.startCircleRad = ce.random_num(0.1, 0.1)))
          break
        case 2:
          ;((e.mapHalfSphere = ce.random_bool(0.7)), (e.mapRepeat = ce.random_bool(0.5)), (e.progressionRat = ce.random_num(0.05, 0.1)), (e.startFormationNum = ce.random_int(3, 10)), (e.startFormationRad = ce.random_num(0.1, 0.5)), (e.startCircleRad = ce.random_num(0.05, 0.1)))
          break
        case 3:
          ;((e.mapHalfSphere = ce.random_bool(0.7)), e.mapHalfSphere && (e.mapRepeat = ce.random_bool(0.8)), (e.progressionRat = ce.random_num(0.2, 0.4)), (e.startFormationNum = ce.random_int(1, 20)), (e.startFormationRad = ce.random_num(0.2, 0.5)), (e.startCircleRad = ce.random_num(0.1, 0.1)))
      }
      return (e.type >= 2 && ce.random_bool(0.4) && ((e.type = 4), (e.biasX = ce.random_num(0.005, 0.1)), (e.biasY = ce.random_num(0.005, 0.1)), (e.mapRepeat = !0), ce.random_bool(0.5) && (e.biasX *= -1), ce.random_bool(0.5) && (e.biasY *= -1)), e)
    })()),
    (me.deformNoiseScale = ce.random_num(0.4, 0.6)),
    (me.deformCoreStrength = me.deformMainStrength = 0))
  let de = 0.5
  if ((1 == me.motionType0 && (de -= 0.1), 1 == me.motionType1 && (de -= 0.1), ce.random_bool(de))) {
  ...
  ;((me.rotationSpeedY = ce.random_num(0.25, 0.3)), (me.rotationSpeedZ = ce.random_num(0, 0.5 * me.rotationSpeedY)), (me.rotateCoreZ = !1), (me.flipRotation = ce.random_bool(0.6)), (me.rotationSpeedDiagram = ce.random_num(0.05, 0.15)), ce.random_bool(0.5) && (me.rotationSpeedDiagram *= -1), ce.random_bool(0.5) && (me.rotationSpeedZ = 0), (me.mainType = 0), ce.random_bool(0.03) && ((me.mainType = 1), (me.rotationSpeedZ = ce.random_num(0, 0.5 * me.rotationSpeedY)), (me.deformMainStrength = 0)), (me.bumpMapSize = ce.random_num(0.5, 1)), 0 == me.rd.type && (me.bumpMapSize = 0), 2 == me.motionType0 && 2 == me.motionType1 && (me.rotateCoreZ = !0), 0 == me.motionType0 && (me.spheres[0].contourVisibility = 0.1), 0 == me.motionType1 && (me.spheres[1].contourVisibility = 0.1))
  let ge = me
  ge.mainType = 0
  ge.deformCoreStrength = 0
  class he {
    #a = {}
    #o = {}
    constructor(e) {
  ...
  function Re() {
    if (!window.HisxeeWindowManager) throw new Error('[hisxee] WindowManager 未注入')
    return new window.HisxeeWindowManager()
  }
  ...
  class He {
    ...
    compute(e) {
      if (this.#Q)
        ...
        ;(this.#ne && (this.#J && ((this.#J.rotation.y = 0.5 * e), (this.#J.position.x = 250), (this.#J.position.y = 500)), this.#j && ((this.#j.rotation.y = 0.5 * e), (this.#j.position.x = 250), (this.#j.position.y = 500))),
  ...
  function qe(e, n, t, a, o) {
    ...
    for (let e = 0; e < c; e++) {
      ...
      ;(d.push(...We(0.75 * u, m + Math.PI, m, 20, n.x, n.y)), e < c - 1 && d.push(...We(0.25 * u, m, m - Math.PI, 10, t.x, t.y)))
    }
    return d
  }
  ...
  function Xe(e, n, t = 10) {
    ...
    if (2 == e.length) ((a = e[0]), (o = e[1]), (r = o.clone().sub(a).normalize()), (s = new $e.Vector3(-r.y, r.x, 0)), (i = a.clone().lerp(o, n)))
      ...
      ;((s = p), (r = f), 0 == u && ((s = p.clone().lerp(d, 0.5)), (r = f.clone().lerp(m, 0.5))))
    }
    let m = -0.5 * t,
      d = i.clone().add(
        s
  ...
  new (class {
    ...
    constructor() {
      ;((this._posVel = new c.Vector3()),
        ...
        (this._isMouseDown = !1),
        window.addEventListener('touchstart', this._mouseDownHandler.bind(this)),
  ...
  ;(console.log('------------------------'),
    ...
    console.log('------------------------'),
    2 == je.debug && (console.log('pairs'), console.log(JSON.stringify(D.getPairs(), null, 2)), console.log('------------------------'), console.log('eth main colors'), console.log(JSON.stringify(ve(0))), console.log('------------------------'), console.log('tez main colors'), console.log(JSON.stringify(ve(1)))),
        ...
        () => {
          ;((Dt = parseFloat(localStorage.getItem(Et)) || 0),
            Ht ||
              (function () {
                ;((On = new Re()),
                  (window.__hisxeeOn = On),
                  On.isObserverMode && On.isObserverMode()
                    ? window.__hisxeeOnEntangledReady && window.__hisxeeOnEntangledReady({ on: On })
                    : (On.setWinShapeChangeCallback(hisxeeOnViewportChange),
            ...
            (function () {
              ;((En = new Ye.OrthographicCamera(0, bn, 0, zn, -1e4, 1e4)),
                ...
                Cn.setPixelRatio(Tn),
                Cn.setSize(0, 0),
                Ot && ((Cn.domElement.style.width = bn / 2 + 'px'), (Cn.domElement.style.height = zn / 2 + 'px')))
            ...
            (function () {
              let e = (function () {
                  ...
                  ;(t(2, 0.5, Oe(i, 100)), t(3, 0.5, Oe(i, 100)), z(2, 0.75, i), z(3, 0.75, i))
                  for (let e = 0; e < h; e++) {
                    let n = e
                    e == h - 1 && T < 0.3 && (n += 1)
                    let t = s + T * n
                  ...
                  for (let e = R; e < P; e++) {
                    ...
                    for (let e = 0; e < n.length; e++) {
                      ...
                      for (let e = 0; e < n.length; e += o) {
                        let o = n[e]
                        ;(a.x == o.x && a.y == o.y) || t(L.random_int(0, 1), 0.6 - 0.5 * _, [a, o])
                      }
                    }
                  }
                  ...
                  for (let e = 0, n = w.length; e < n; e++) {
                    ...
                    let i = [],
                      ...
                      c = 1,
                      u = L.random_bool(0.2)
                    ;(e == w.length - 1 && (u = !1), e == w.length - 1 && (c = 0.3), L.random_bool(0.5))
                    let m = !1
                    ;(0 == e && 3 == d && (m = !0), m && (u = !0))
                    let p = -1,
                      v = s.length - f
                  ...
                  for (let e = 0; e < E.length; e++) {
                    ...
                    for (let l = 0, c = n.length; l < c; l += f) {
                      ...
                      function f(n, r, s) {
                        ...
                        switch ((s > 0 && (c = 0), e == w.length - 2 && (c = 0), 0 == c && L.random_bool(0.5) && (l = [l[1], l[0]]), c)) {
                          case 0:
                            ;(t(i, 1, [n, r]), (e == w.length - 2 || L.random_bool(0.5)) && t(i, 1, Xe(l, 0.5, a)))
                            break
                          case 1:
                      ...
                      ;((i = L.random_int(0, 1)), L.random_bool(0.2) && (i += 2), c > -1 ? (e < w.length - 1 && L.random_bool(0.5) && f(n[m], r[d], c), (u > -1 || 0 == l) && t(i, 1, Ge(n[l]))) : u > -1 && t(i, 1, Ge(n[l])))
                    }
                  }
                  return e
                })(),
            ...
            (function () {
              ;((nn = new l(mt, dt, Cn)),
                (hn = nn.createTexture()),
                (xn = nn.addVariable('texturePolarAcc', `\nuniform int frame;\nuniform float time;\n${f}\n${d}\n${u}\nvoid main () \n{\nfloat nPoints = resolution.x * resolution.y;\nfloat i = (gl_FragCoord.y * resolution.x) + gl_FragCoord.x;\nvec2 uv = gl_FragCoord.xy / resolution.xy;\nvec4 pPos = texture2D(texturePolarPos, uv);\nvec3 acc = vec3(0.0);\ngl_FragColor = vec4(acc.xyz, 1.0);\n}`, hn)),
                ...
                (vn = nn.createTexture()),
                (gn = nn.addVariable('texturePolarVel', `\nuniform int frame;\nuniform float time;\n${f}\n${d}\nvoid main () \n{\nfloat nPoints = resolution.x * resolution.y;\nfloat i = (gl_FragCoord.y * resolution.x) + gl_FragCoord.x;\nvec2 uv = gl_FragCoord.xy / resolution.xy;\nvec4 pVel = texture2D(texturePolarVel, uv);\nvec4 pAcc = texture2D(texturePolarAcc, uv);\nvec3 vel = vec3(0.0);\nif (frame > 0)\n{\nvel = pVel.xyz + pAcc.xyz; \n}\nvel *= .9;\ngl_FragColor = vec4(vel.xyz, 1.0);\n}`, vn)),
            ...
            (function () {
              ...
              for (let e = 0; e < 2; e++)
                for (let n = 0; n < 3 && !(i >= r.length); n++) {
                  ...
                  ;(0 == i ? (t.material.color = new Ye.Color(15, 15, 15, 0)) : 1 == i && (t.material.color = new Ye.Color(5, 5, 5, 0)), (t.position.x = -0.5 * (1 - a) + a * n), (t.position.y = 0.5 * (1 - o) - o * e), (t.material.map = r[i]), (t.material.map.offset = new Ye.Vector2((1 / mt) * 2, 0)), Gn.add(t), i++)
                }
              ;(((Gn.position.x = -0.5), (Gn.position.y = 0.5), (Gn.scale.x = bn), (Gn.scale.y = zn), Xn.add(Gn)), hisxeeApplyPaletteColors(), hisxeeInstallPickApi())
            })(),
            je.fps &&
              (function () {
  ...
  function hisxeeScreenXY() {
    return {
      x: typeof window.screenX === 'number' ? window.screenX : window.screenLeft,
      y: typeof window.screenY === 'number' ? window.screenY : window.screenTop
    }
  }

  function hisxeeColorsToVec4(e) {
    return e.map(n => new Ye.Vector4(n.r, n.g, n.b, 1))
  }

  const HISXEE_PALETTE_GREEN = [0x030a06, 0x14c45a, 0x6aff9e]
  const HISXEE_PALETTE_PARTNER = [0x030610, 0x1648a0, 0x2d5fd4]

  function hisxeeApplyPaletteColors() {
    Wn = Xt(HISXEE_PALETTE_GREEN)
    kn = Xt(HISXEE_PALETTE_PARTNER)
    if (Ln && Ln.material && Ln.material.uniforms) {
      Ln.material.uniforms.colors0.value = hisxeeColorsToVec4(Wn)
      Ln.material.uniforms.colors1.value = hisxeeColorsToVec4(kn)
    }
    const body = document.getElementsByTagName('body')[0]
    if (body && ht >= 1) {
      const tw = On && On.getThisWindowData()
      const idx = tw && tw.metaData ? tw.metaData.instanceIndex : 0
      const pal = idx === 1 ? kn : Wn
      body.style.background = '#' + pal[0].getHexString()
    }
  }

  const HISXEE_PICK_BRIGHTNESS = 0.035

  function hisxeeHitInstanceShape(shape, x, y) {
    return shape && shape.z > 0 && shape.w > 0 && x >= shape.x && x <= shape.x + shape.z && y >= shape.y && y <= shape.y + shape.w
  }

  function hisxeePointerToScene(clientX, clientY) {
    if (!Cn || bn <= 0 || zn <= 0) return null
    const rect = Cn.domElement.getBoundingClientRect()
    if (rect.width <= 0 || rect.height <= 0) return null
    if (clientX < rect.left || clientX > rect.right || clientY < rect.top || clientY > rect.bottom) return null
    const u = (clientX - rect.left) / rect.width
    const v = (clientY - rect.top) / rect.height
    return { u: u, v: v, xBn: u * bn, yBn: v * zn, clientX: clientX, clientY: clientY }
  }

  function hisxeeResolveWindowIndex(xBn, yBn) {
    const slots = [
      { shape: Tt.shape, vis: Tt.visibility, id: Tt.id, idx: 0 },
      { shape: bt.shape, vis: bt.visibility, id: bt.id, idx: 1 }
    ]
    let best = null
    for (let n = 0; n < slots.length; n++) {
      const s = slots[n]
      if (-1 == s.id || s.vis < 0.05) continue
      if (!hisxeeHitInstanceShape(s.shape, xBn, yBn)) continue
      const cx = s.shape.x + 0.5 * s.shape.z
      const cy = s.shape.y + 0.5 * s.shape.w
      const d2 = (xBn - cx) * (xBn - cx) + (yBn - cy) * (yBn - cy)
      if (!best || d2 < best.d2) best = { windowIndex: s.idx, d2: d2 }
    }
    if (best) return best.windowIndex
    const tw = On && On.getThisWindowData()
    return tw && tw.metaData && tw.metaData.instanceIndex === 1 ? 1 : 0
  }

  function hisxeeHoverAt(clientX, clientY) {
    const p = hisxeePointerToScene(clientX, clientY)
    if (!p) return null
    const slots = [
      { shape: Tt.shape, vis: Tt.visibility, id: Tt.id, idx: 0 },
      { shape: bt.shape, vis: bt.visibility, id: bt.id, idx: 1 }
    ...
    for (let n = 0; n < slots.length; n++) {
      const s = slots[n]
      if (-1 == s.id || s.vis < 0.05) continue
      if (!hisxeeHitInstanceShape(s.shape, p.xBn, p.yBn)) continue
      const cx = s.shape.x + 0.5 * s.shape.z
      const cy = s.shape.y + 0.5 * s.shape.w
      const r = 0.45 * Math.min(s.shape.z, s.shape.w)
      const d2 = (p.xBn - cx) * (p.xBn - cx) + (p.yBn - cy) * (p.yBn - cy)
      if (d2 <= r * r) return { windowIndex: s.idx, clientX: p.clientX, clientY: p.clientY }
    }
    return null
  }

  function hisxeePickAt(clientX, clientY) {
    const p = hisxeePointerToScene(clientX, clientY)
    if (!p || !Bn) return null
    const rx = Math.min(Math.max(0, Math.floor(p.u * bn * Tn)), Math.max(0, Math.floor(bn * Tn) - 1))
    const ry = Math.min(Math.max(0, Math.floor((1 - p.v) * zn * Tn)), Math.max(0, Math.floor(zn * Tn) - 1))
    const buf = new Uint8Array(4)
    try {
      Cn.readRenderTargetPixels(Bn, rx, ry, 1, 1, buf)
    } catch (err) {
      return null
    }
    const brightness = (buf[0] + buf[1] + buf[2]) / (3 * 255)
    if (brightness < HISXEE_PICK_BRIGHTNESS) return null
    return {
      windowIndex: hisxeeResolveWindowIndex(p.xBn, p.yBn),
      clientX: p.clientX,
      clientY: p.clientY,
  ...
  function hisxeeInstallPickApi() {
    window.__hisxeePick = { pickAt: hisxeePickAt, hoverAt: hisxeeHoverAt }
  }

  function hisxeeResolvedWindows() {
    if (!On) return []
    return On.getWindows().filter(w => w.metaData && w.metaData.resolvedIteration == D.resolved())
  }

  function hisxeeSyncDualWindowState() {
    if (hisxeeResolvedWindows().length < 2 || Tt.id === -1 || bt.id === -1) return
    lt = 0
    Tt.isPreLoading = 0
    bt.isPreLoading = 0
    Tt.visibilityTarget = 1
    bt.visibilityTarget = 1
    if (On) On.setMetaData('isPreLoading', 0)
  }

  function hisxeeActiveSlot() {
    const tw = On && On.getThisWindowData()
    const idx = tw && tw.metaData != null ? tw.metaData.instanceIndex : V
    return idx === 1 ? bt : Tt
  }

  function hisxeeCanvasSize() {
    const scale = it || 1
    return {
      w: bn > 0 ? bn : window.innerWidth * scale,
      h: zn > 0 ? zn : window.innerHeight * scale
    }
  }

  function hisxeeForceInstanceValue() {
    if (hisxeeResolvedWindows().length >= 2) return -1
    const tw = On && On.getThisWindowData()
    if (!tw || tw.metaData == null) return 0
    return tw.metaData.instanceIndex === 1 ? 1 : 0
  }

  function hisxeeRefreshInstanceShapes() {
    if (!On) return
    const wins = On.getWindows()
    if (Tt.id !== -1) {
      const w = wins.find(x => x.id === Tt.id)
      if (w) Tt.shape = hisxeeInstanceShape(w)
    }
    if (bt.id !== -1) {
      const w = wins.find(x => x.id === bt.id)
      if (w) bt.shape = hisxeeInstanceShape(w)
    }
  }

  function hisxeeOnViewportChange() {
    qt(!1)
    hisxeeRefreshInstanceShapes()
  }

  /** 将桌面全局窗口矩形转换到当前标签页视口坐标，本窗固定 (0,0,w,h) 居中 */
  function hisxeeInstanceShape(n) {
    if (!n) return new Ye.Vector4(0, 0, 0, 0)
    const tw = On && On.getThisWindowData()
    const { w, h } = hisxeeCanvasSize()
    if (tw && tw.id === n.id) {
      return new Ye.Vector4(0, 0, w, h)
    }
    const s = hisxeeScreenXY()
    const scale = window.innerWidth > 0 ? w / window.innerWidth : 1
    return new Ye.Vector4(
      (n.shape.x - s.x) * scale,
      (n.shape.y - s.y) * scale,
      n.shape.w * scale,
      n.shape.h * scale
  ...
  function Nt() {
    ...
    function a(e, n) {
      if (null != n) {
        ...
        e.walletsOwner = []
        e.isPreLoading = 1
        e.shape = new Ye.Vector4(0, 0, 0, 0)
        e.visibility = 0
      }
    }
    ;((zt = []),
      e.forEach(e => {
        e.metaData.resolvedIteration == D.resolved()
          ? 0 == e.metaData.instanceIndex
            ? slot0.push(e)
            : 1 == e.metaData.instanceIndex && slot1.push(e)
          : zt.push(e)
      }),
      slot0.sort((a, b) => a.id - b.id),
      slot1.sort((a, b) => a.id - b.id),
      (St = zt.length),
      a(Tt, slot0[0]),
      a(bt, slot1[0]))
    ;((function () {
    ...
    ;(function () {
      const tw = On.getThisWindowData()
      tw && tw.metaData && tw.metaData.isSphere != o && On.setMetaData('isSphere', o)
    })()
    hisxeeSyncDualWindowState()
    if (-1 != Tt.id && -1 == bt.id) {
      Tt.visibilityTarget = 1
      Tt.isPreLoading = 0
    }
  ...
  function Ut() {
    ...
    for (let n = 0; n < e.length; n++) {
      ...
      if (t.metaData.isSphere && t.id != Tt.id && t.id != bt.id) {
        ...
        let a = Qt(n),
          sxy = hisxeeScreenXY(),
          o = new Ye.Vector4(t.shape.x - sxy.x + 0.5 * t.shape.w, t.shape.y - sxy.y + 0.5 * t.shape.h, a, 0),
  ...
  function Jt() {
    if (hisxeeResolvedWindows().length >= 2) {
      Tt.visibilityTarget = 1
      bt.visibilityTarget = 1
      return
    }
    const e = hisxeeActiveSlot()
  ...
  function Zt(e) {
    let n,
      t = hisxeeActiveSlot()
    if ((hisxeeResolvedWindows().length >= 2 ? ((Tt.visibilityTarget = 1), (bt.visibilityTarget = 1)) : Ht || (t.visibilityTarget = 1), !st)) {
      if (Kt()) {
        let e = 1 / 60
    ...
    if ((Nn && (Nn.innerText = 'fps: ' + $n + ': ' + ot), jn.isDone() && !It)) {
      ;((lt = 0),
        -1 != Tt.id && (Tt.isPreLoading = 0),
        -1 != bt.id && (bt.isPreLoading = 0),
        (ct = ot),
    ...
    if (-1 != Tt.id && -1 != bt.id) {
      ...
      let e = new Ye.Vector2(Tt.shape.x + 0.5 * Tt.shape.z, Tt.shape.y + 0.5 * Tt.shape.w),
        t = new Ye.Vector2(bt.shape.x + 0.5 * bt.shape.z, bt.shape.y + 0.5 * bt.shape.w)
      a = e.distanceTo(t)
    } else n = t.shape.w
    let o = Qt(n)
    ;(Dn.rotateOnWorldAxis(new THREE.Vector3(0, 1, 0), 0 * Ze.y), Dn.rotateOnWorldAxis(new THREE.Vector3(1, 0, 0), 0 * Ze.x))
    let r = new Ye.Vector3(0, 0, 0)
    Ht && (r = new Ye.Vector3(Pn.x - xt.x, Pn.y - xt.y, 0))
    ...
    let l = [Tt.shape, bt.shape],
      c = [-1 == Tt.id ? 0 : Tt.visibility, -1 == bt.id ? 0 : bt.visibility]
    ;((dn.material.uniforms.time = {
      value: Vn
    }),
      (dn.material.uniforms.sphereRadius = {
      ...
      (dn.material.uniforms.instanceIndex = {
        value: (() => {
          const tw = On && On.getThisWindowData()
          return tw && tw.metaData && tw.metaData.instanceIndex != null ? tw.metaData.instanceIndex : V
        })()
      }),
      (dn.material.uniforms.hisxeeForceInstance = {
        value: hisxeeForceInstanceValue()
      }),
      (dn.material.uniforms.rdPolyTex = {
        value: Yn
      }),
    ...
    ;((Tt.visibility += (Tt.visibilityTarget - Tt.visibility) * u),
      ...
      Pn.x,
      Pn.y,
      Kt() ? (gt = 1) : lt && gt < 0.25 ? (gt += 0.01) : !lt && gt < 1 && (gt += 0.02),
      (Un.material.uniforms.time = {
        value: Vn
      }),
    ...
    if ((0 == lt && ot > ct + 400 && !Sn && (Sn || (console.log('trigger preview'), $fx.preview(), (Sn = !0))), (Kt() && -1 != ct && ot > ct + 290) || (!Kt() && !st))) {
      Kt() && console.log('rendering')
      {
        ...
        ;(Cn.setRenderTarget(Bn),
          ...
          (Ln.material.uniforms.colors0 && (Ln.material.uniforms.colors0.value = hisxeeColorsToVec4(Wn)),
          Ln.material.uniforms.colors1 && (Ln.material.uniforms.colors1.value = hisxeeColorsToVec4(kn))),
  ...
  function na() {
    ...
    ;(Kt() && console.log('preview width', s, 'height', l, 'pixR', Tn, 'scale', it),
      (s *= it),
      (l *= it),
      (bn == s && zn == l) ||
        ((bn = s),
        (zn = l),
        console.log('perform resize: ', bn, zn),
        (En.left = En.top = 0),
        (En.right = bn),
        (En.bottom = zn),
